...
curl --location "https://private.au-syd.ml.cloud.ibm.com/ml/v4/deployments/019e84ff-5f6b-7054-9c70-521fa6667a8e/predictions?version=2021-05-01" --header "Content-Type: application/json" --header "Accept: application/json" --header "Authorization: Bearer $IAM_TOKEN" --data '{
		 "input_data": [
		     {
